...
class HrEmployee(models.Model):
    ...
    gosi_ids = fields.Many2one('employee.gosi', 'GOSI NO', ondelete='restrict')
...
class EmployeeGosi(models.Model):
    ...
    gosi_rule_id = fields.Many2one('gosi.contribution.setting', required=True)
    employee_id
    _sql_constraints = [
